...
public class FPContext {
     ...
     * @return ドキュメントの種類
     */
    public FPDocumentType getDocumentType() {
        return FPPoiUtil.getDocumentType(outSheet);
    }

    /**
     * RichTextStringを生成して戻します。
     * @param text
     * @return RichTextString
     */
    public RichTextString createRichTextString(String text) {
        return FPPoiUtil.createRichTextString(getDocumentType(), text);
    }

    /**
     * ClientAnchorを生成して戻します。
     * @return ClientAnchor
     */
    public ClientAnchor createClientAnchor() {
        return FPPoiUtil.createClientAnchor(getDocumentType());
    }
     ...
     * @return Hyperlink
     */
    public Hyperlink createHyperlink(int linkType) {
        return FPPoiUtil.createHyperlink(getDocumentType(), linkType);
    }
