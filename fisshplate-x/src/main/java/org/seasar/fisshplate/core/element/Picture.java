...
public class Picture extends AbstractCell {
     ...
     * @return
     */
    private ClientAnchor createAnchor(int width, int height, int cellNo, int rowNo, int cellRangeIntVal, int rowRangeIntVal, FPContext context) {
        ClientAnchor anchor = context.createClientAnchor();
    ...
    private void writePicture(String picturepath, int cellRangeIntVal, int rowRangeIntVal, FPContext context) throws FPMergeException {
        ...
        ClientAnchor anchor = createAnchor(imgWidth, imgHeight, cellNo, rowNo, cellRangeIntVal, rowRangeIntVal, context);
