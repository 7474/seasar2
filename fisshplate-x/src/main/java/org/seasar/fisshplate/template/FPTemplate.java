...
public class FPTemplate {
     ...
     */
    public Workbook process(String templateName, Map<String, Object> data) throws FPParseException, FPMergeException,IOException {
        InputStream is = InputStreamUtil.getResourceAsStream(templateName);
        Workbook workbook = FPPoiUtil.createWorkbook(new POIFSFileSystem(is));
     ...
     *             ファイルIOでエラーが発生した際に投げられます。
     */
    public Workbook process(InputStream is, Map<String, Object> data) throws FPParseException,FPMergeException,IOException {
        return process(FPPoiUtil.createWorkbook(new POIFSFileSystem(is)), data);
    }
     ...
     * @throws FPMergeException データ埋め込み時にエラーが発生した際に投げられます。
     */
    public Workbook process(Workbook poiWorkbook, Map<String, Object> data) throws FPParseException,FPMergeException {
        WorkbookWrapper workbook = new WorkbookWrapper(poiWorkbook);
