...
public class FPPreviewUtilTest extends TestCase {
    ...
    public void testプレビュー2() throws Exception{
        Workbook data =  FPPoiUtil.createWorkbook(getClass().getResourceAsStream("/MapBuilderTest.xls"));
        Workbook template = FPPoiUtil.createWorkbook(getClass().getResourceAsStream("/MapBuilderTest_template.xls"));
